...
var lightPosition = [[1.0, 1.3, -1.3], [-0.0, 1.3, -1.3], [5.0, 5.0, -1.3], [5.0, 5.0, -1.3],
            ...
            for (i=0; i < currSceneObject ; i++) { 
                ...
                switch (sceneObjects) {
                    case 5: // sofa
                        ...
                        objectWorldMatrix[sceneObjects] = utils.multiplyMatrices(
                            objectWorldMatrix[sceneObjects],
                            utils.MakeTranslateMatrix(-0.5,0.0,-2.2));
                        break;
                    case 6: // bed
                        objectWorldMatrix[sceneObjects] = utils.multiplyMatrices(
                            objectWorldMatrix[sceneObjects],
                        ...
                        objectWorldMatrix[sceneObjects] = utils.multiplyMatrices(
                            objectWorldMatrix[sceneObjects],
                            utils.MakeTranslateMatrix(-1.5, 0.0, -0.8));
                        break;
                    case 7: // chair
                        objectWorldMatrix[sceneObjects] = utils.multiplyMatrices(
                            objectWorldMatrix[sceneObjects],
                            utils.MakeTranslateMatrix(-1.5, 0.0, -1.4));
                        objectWorldMatrix[sceneObjects] = utils.multiplyMatrices(
                            objectWorldMatrix[sceneObjects],
