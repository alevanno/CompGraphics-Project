...
var lightPosition = [[0.0, -0.0, -1.0], [10.0, 10.0, 10.0], [10.0, 10.0, 10.0], [10.0, 10.0, 10.0],
...
var zones = [[], [], [], [], [],
    [-0.7, -2.0, 2.0, -0.5], //sofa
    [-2.0, 2.0, 0.5, -0.0], //bed
    [-2.0, -2.0, -0.5, -0.5], //chair
    [-1.72, 1.5, -2.7, 3.0], //closet
    [-1.0, 1.5, -1.71, 3.0], //sofa2
    [], //chair2
    [], //chair3
    [0.8, 1.5, -0.4, 3.0]];
function popup(x, y) {
