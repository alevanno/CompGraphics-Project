...
var dirLightAlpha1 = -utils.degToRad(240);
...
var lightPosition = [[3.0, 1.3, -1.3], [-0.0, 0.0, -1.3], [5.0, 5.0, -1.3], [5.0, 5.0, -1.3],
                    [5.0, 5.0, -1.3], [5.0, 5.0, -1.3], [5.0, 5.0, -1.3], [5.0, 5.0, -1.3]];	
...
function main(){
	...
	if(gl){
		...
		perspectiveMatrix = utils.MakePerspective(70, w/h, 0.1, 100.0);
...
function loadModel(modelName){
    ...
    utils.get_json(modelsDir + modelName, function(loadedModel){
        ...
        for (i=0; i < currSceneObject ; i++) { 
            ...
            //console.log('sceneObjects vale '+ sceneObjects);
            // Mesh color, where:
            // Diffuse value
